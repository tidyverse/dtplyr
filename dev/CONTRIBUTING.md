...
This outlines how to propose a change to dtplyr. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("batpigandme/dtplyr", fork = TRUE)`.
...
of Conduct](https://dtplyr.tidyverse.org/dev/CODE_OF_CONDUCT.md). By
