...
dtplyr is currently marked as experimental because it has little usage in the wild. I expect that it will rapidly move towards maturing after a few weeks of feedback from users.
